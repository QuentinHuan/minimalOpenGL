...
public:
    // model data
    vector<Texture> textures_loaded; // stores all the textures loaded so far, optimization to
...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene) {
        ...
        // 2. Roughness maps
        vector<Texture> specularMaps = loadMaterialTextures(material, aiTextureType_SHININESS, "texture_roughness");
        textures.insert(textures.end(), specularMaps.begin(), specularMaps.end());
        // 3. metalness maps
        std::vector<Texture> metalMaps = loadMaterialTextures(material, aiTextureType_SPECULAR, "texture_metalness");
        textures.insert(textures.end(), metalMaps.begin(), metalMaps.end());
        // 4. normal maps
        std::vector<Texture> normalMaps = loadMaterialTextures(material, aiTextureType_HEIGHT, "texture_normal");
        textures.insert(textures.end(), normalMaps.begin(), normalMaps.end());
        // 5. AO maps
        std::vector<Texture> AOMaps = loadMaterialTextures(material, aiTextureType_UNKNOWN, "texture_AO");
